      ...
      <div class="space-y-10">
        ...
        <section>
            ...
            <div class="bg-blue-100 text-blue-700 p-2.5 rounded-xl" aria-hidden="true">
              ...
              >
                ...
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="2"
                  d="M19 19a2 2 0 01-2 2H7a2 2 0 01-2-2v-2c0-1.5 2.5-3 5-3h4c2.5 0 5 1.5 5 3v2z"
                ></path>
              </svg>
            </div>
          ...
          <p class="text-slate-600 leading-relaxed pl-2 border-l-4 border-blue-500">
            ...
            (como NVDA ou VoiceOver) sempre que são abertos ou fechados.
          </p>
        </section>
...
<script setup>
// Página estática puramente informativa
</script>
